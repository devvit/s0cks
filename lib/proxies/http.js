...
function createServer({
  ...
  const isAuthRequired = username !== '' && password !== ''; // Simple HTTP Proxy
  ...
  server.on('request', (req, res) => {
    ...
    server.emit('proxyConnection', socket, {
      ...
      onConnected: send => {
        ...
        headers['connection'] = 'close'; // rebuild headers
        ...
        send(Buffer.from(reqMsg)); // free to recv from application now
